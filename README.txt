...
Data that can be extracted comes from get_country_data() function. Returns a list of 3 items starting with: number of cases, number of deaths and number of 
recoveries.
